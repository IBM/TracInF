...
## may test other BERT family model ##
    ...
    BERT_Model = RobertaForSequenceClassification.from_pretrained(
            'roberta-large', num_labels=2, output_hidden_states=True)
...
if __name__=='__main__':
    ...
    parser.add_argument("--train_data_name", default="sentihood_model_5_train_w_qa.json", type=str, required=False, help="The input training data name")
    parser.add_argument("--dev_data_name", default="sentihood_model_5_dev_w_qa.json", type=str, required=False, help="The input dev data name")
    parser.add_argument("--test_data_name", default='sentihood_model_5_test_w_qa.json', type=str, required=False, help="The input testing data name")
    parser.add_argument("--model_output", default='sentihood.out', type=str, required=False, help="The output directory where the model checkpoints saved")
    parser.add_argument("--max_seq_length", default=60, type=int, help="")
    parser.add_argument("--batch_size", default=64, type=int, help="Total batch size for training and eval.")
    parser.add_argument("--epochs", default=20, type=int, help="Total number of training epochs to perform.")
    parser.add_argument("--seed", default=1, type=int, help="Random seed")
    parser.add_argument("--num_labels", default=2, type=int, help="labels to predict")
    ...
    print(f"dev distribution {Counter(dev_labels)}")
...
#                token_type_ids=None,
        ...
        if eval_accuracy / nb_eval_steps > global_eval_accuracy:
            global_eval_accuracy = eval_accuracy  / nb_eval_steps
            save_model(BERT_Model, BERT_name + '-b100-' + args.model_output)

    print("Best Validation Accuracy: {}".format(global_eval_accuracy))