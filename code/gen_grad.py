...
'''
This is simply generating the s_test gradients purpose..
'''
...
#    parser.add_argument("--test_sample_num", default=1332, type=int, required=True,help="test sample number")
    parser.add_argument("--num_classes", default=2, type=int, required=True,help="num of classes for the model")
    ...
    parser.add_argument('--mask_version', action='store_true')
    ...
    traindids, traintids, trainx, trainm, trainl = dr.read_data(
        args.data_dir + args.train_data_name + '.json', mask_version=args.mask_version )
    testdids, testtids, testx,  testm,  testl  = dr.read_data(
        args.data_dir + args.test_data_name + '.json', mask_version=args.mask_version )
...
#            "test_sample_num": args.test_sample_num,
    ...
    ptif.calc_all_grad_then_test(
        config, model, trainloader, testloader,
